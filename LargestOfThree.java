...
public class LargestOfThree {
    public static void main(String[] args) {
        ...
        System.out.printf("\n\n Welcome to my largest of three programs!");
        ...
        if (num1 > num2) {
            ...
            System.out.println("\n You entered " + num1 + " for the value pf num1.\n");
        System.out.println("\n You entered " + num2 + " for the value pf num1.\n");
        System.out.println("\n You entered " + num3 + " for the value pf num1.\n");
